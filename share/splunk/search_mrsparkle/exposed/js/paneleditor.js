    ...
    */
    ...
    PanelModel.escapeChartingProperties = function(unescapedFields) {
        ...
        for(var key in options) {
            if(options.hasOwnProperty(key) && PanelModel.isChartingProperty(key) 
            ...
            var picker = this,
                ...
                setElementRangeInfo = function($element, rangeInfo) {
                    ...
                    if(rangeInfo.color !== undefined) {
                        $('.rangecolorpicker div', $element).eq(0)
                            .css('background-color', rangeInfo.color.replace("0x", "#"));
                    }
                ...
                addRange = function(rangeInfo) {
                    ...
                    $clone.removeClass('rangeselecttemplate')
                        .addClass('rangeselect')
                        .insertAfter($('.rangeselecttemplate, .rangeselect', $(container)).last())
                        .show();
                    numRanges++;
                };
